...
time python test.py --output_path ./output --image_path ./assets/gaosu/1736503211099999810.jpg --prompt_depth_path ./assets/gaosu/pts_depth.npz --intrinsic_path ./assets/gaosu/center_camera_fov30-intrinsic.json
